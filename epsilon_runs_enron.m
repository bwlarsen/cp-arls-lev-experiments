...
fprintf('---Load in Enron Tensor (with log counts)---\n')
load ('/home/bwlarse/Tensors/tensor_data_enron_large/enron_emails_log.mat');
...
load('/home/bwlarse/Tensors/tensor_data_enron_large/enron_emails_log_solution.mat')
A = M.u;
R = ncomponents(M);
...
rnginit;
[results_rand,info_rand] = epsilon_runs_rand_range(X,R,krng,srng,crng,trng,ntrials);

%%
save('-v7.3', aname,'results_rand', 'info_rand');
