function [results,info] = epsilon_runs_nofit(X,A,krng,srng,crng,trng,ntrials,combrep)
        ...
        for cidx = 1:nc
            ...
            for tidx = 1:nt
                ...
                for trialidx = 1:ntrials
                    ...
                    tic
                    [Vs,info] = tt_sampled_solve(X,A,Alev,k,s,c,t,Xfidxs(:,k),combrep,1);
