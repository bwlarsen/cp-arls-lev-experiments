function [results,info] = epsilon_runs(X,A,krng,srng,crng,trng,ntrials, calcres, combrep)
...
%      - CALCRES = True to calculation residual of sampled system. 
        ...
        for cidx = 1:nc
            ...
            for tidx = 1:nt
                ...
                for trialidx = 1:ntrials
                    ...
                    tic
                    [Vs,info] = tt_sampled_solve(X,A,Alev,k,s,c,t,Xfidxs(:,k),calcres, combrep);
